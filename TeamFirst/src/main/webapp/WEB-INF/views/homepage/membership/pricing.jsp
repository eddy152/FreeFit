  ...
  <div class="container">
    <div class="card-deck mb-3 text-center">
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <h1 class="card-title pricing-card-title">9,999 원<small class="text-muted">/ 월</small></h1>
          <ul class="list-unstyled mt-3 mb-4">
      ...
      <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
          <h1 class="card-title pricing-card-title">99,999 원<small class="text-muted">/ 월</small></h1>
          <ul class="list-unstyled mt-3 mb-4">
            <li>트레이너 무제한</li>
            <li>회원 무제한</li>
            <li>피트니스 관리</li>
