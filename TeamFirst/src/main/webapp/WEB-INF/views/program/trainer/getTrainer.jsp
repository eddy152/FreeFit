			...
			<div class="panel panel-default">
				...
				<div align="center" class="panel-body">
					<table class="table table-hover">
						...
						<tr>
							<th>이름</th>
							<td><input name="name" value="${emp.name}" readonly="readonly"></td>
						</tr>
						<tr>
							<th>연락처</th>
							<td><input name="phone_number" value="${emp.phone_number}" readonly="readonly"></td>
						</tr>
						<tr>
							<th>성별</th>
							<td><input name="gender" value="${emp.gender}" readonly="readonly"></td>
						</tr>
						<tr>
							<th>입사날짜</th>
