...
$(document).ready(function() {
	  ...
	  $("#summernote").summernote('code',  '${up.content}');
	});
...
<h2 style="text-align: center;">수정 페이지</h2><br><br><br>
	<form method="post" action="userUpdate" >
		...
		게시물번호 : <input readonly="readonly" type="text" name="board_no" value="${up.board_no}"><br>
		제목 : <input type="text" name="title" style="width: 30%;" placeholder="제목" value="${up.title}"/>
		<br><br> 
